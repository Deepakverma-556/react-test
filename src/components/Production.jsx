...
const Production = () => {
    return (
        <div className='bg-dark-purple min-h-screen d-flex align-items-center pt-3'>
            <div className='container custom-container px-3'>
                <div className='d-flex flex-xl-row gap-3 flex-column'>
                    <div className='bg-light-purple text-white pt-3 pb-xl px-26 xl-max-w-437 rounded-3'>
